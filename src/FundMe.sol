...
contract FundMe {
    ...
    uint256 public constant MINIMUM_USD = 6 * 10 ** 18;
    AggregatorV3Interface private Feeds;
    
    constructor(address feeds) {
        i_owner = msg.sender;
        Feeds = AggregatorV3Interface(feeds);
    }

    function fund() public payable {
        require(msg.value.getConversionRate(Feeds) >= MINIMUM_USD, "You need to spend more ETH!");
